...
public class Ranking_30sFragment extends Fragment {
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_ranking_30s, container, false);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rankingData.add(new RankingData(2,1,R.drawable.main_perfume,"이니스프리", "innisfree","피부에 휴식을 주는 섬"));
