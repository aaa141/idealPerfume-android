...
public abstract class MyPickSwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public MyPickSwipeHelper(Context context, RecyclerView recyclerView, int buttonWidth) {
...
//                c.drawText(text, rectF.centerX(), rectF.centerY() , p);
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            if (dX < 0) {
                ...
                if (!buttonBuffer.containsKey(pos)) {
                    instantiaterMyButton(viewHolder, buffer);
    ...
    public abstract void instantiaterMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buffer);
}
